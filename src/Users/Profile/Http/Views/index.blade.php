    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-12 col-lg-10">
            <div class="card p-2 py-0 py-lg-5 driver-card overflow-hidden">
                <form action="{{ route('users.profile.updateAvatar') }}" enctype="multipart/form-data" method="POST"
                                ...
                                <div class="input-group mt-4">
                                    <div>
                                        <a class="btn btn-danger border-radius-0 py-1 mr-1"
                                           ...
                                           href="{{ route('users.profile.deleteAvatar') }}">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="input-group my-3 d-flex align-items-center">
                                ...
                                <span class="input-group-text" style="line-height: 1.3" id="inputGroup-sizing-default">
                                 {{ user()->isCompany() ? 'Название компании' : 'ФИО'  }}:
                                </span>
                                </div>
                            ...
                            @if (!user()->isDriver() && !user()->isCompany())
                                ...
                                <div class="input-group mb-3 d-flex align-items-center">
                                    ...
                                    <input value="{{ $eds }}" disabled type="text"
                                           class="form-control p-3 fw-bold" aria-label="Default"
                                           aria-describedby="inputGroup-sizing-default">
                                </div>
                                ...
                                <div class="input-group mb-3 d-flex align-items-center">
                                    ...
                                    <input value="{{ $timezone }}" disabled type="text"
                                           class="form-control p-3 fw-bold" aria-label="Default"
                                           aria-describedby="inputGroup-sizing-default">
                                </div>
                            @endif
                            ...
                            @if (!$user->isCompany())
                                ...
                                <div class="input-group mb-3 d-flex align-items-center">
                                    ...
                                    <input value="{{ $pvName ?? 'Неизвестно' }}" disabled type="text"
                                           class="form-control p-3 fw-bold" aria-label="Default"
                                           aria-describedby="inputGroup-sizing-default">
                                </div>
                            @endif
                            ...
                            @if ($user->isCompany())
                                <div class="input-group mb-3 d-flex align-items-center flex-nowrap">
                                    ...
                                    @if($user->relatedCompany->document_bdd)
                                        <a href="{{ $user->relatedCompany->document_bdd }}"
                                           class="form-profile-link pl-3">
                                            {{ $user->relatedCompany->document_bdd }}
                                        </a>
                                    @else
