...
return [
    ...
    'registries' => [
        ...
        'driver' => [
            ...
            'time_of_pressure_ban' => 'Время запрета повторного осмотра при повышенном давлении',
            'time_of_alcohol_ban' => 'Время запрета повторного осмотра при положительном тесте на алкоголь'
        ],
