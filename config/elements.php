        ...
        'fields' => [
            ...
            'field' => [
                ...
                'values' => [
                    ...
                    'date_techview' => 'Дата окончания действия диагностической карты (автомобиль)',
    ...
    'Car' => [
        ...
        'fields' => [
            ...
            'type_auto' => [
                ...
                'type' => 'select',
                'values' => [
                    'М - мототехника (мопеды\мотоциклы\трициклы и т.п.)' => 'М - мототехника (мопеды\мотоциклы\трициклы и т.п.)',
            ...
            'date_techview' => [
                'label' => 'Дата окончания действия диагностической карты',
                'type' => 'date',
                'noRequired' => 1
            ],
            'time_skzi' => [
