                    ...
                    @if($type_ankets !== 'pak_queue')
                        ...
                        @if($permissionToView)
                            <ul class="nav nav-tabs" id="filter-groups" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="filter-group-1-tab" data-toggle="tab"
                                       href="#filter-group-1" role="tab" aria-controls="filter-group-1"
                                       aria-selected="true"><i class="fa fa-filter"></i> Первая группа фильтров</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="filter-group-2-tab" data-toggle="tab" href="#filter-group-2"
                                       role="tab" aria-controls="filter-group-2" aria-selected="false"><i
                                            class="fa fa-filter"></i> Вторая группа фильтров</a>
                                </li>
                            </ul>
                                    ...
                                    <tr data-field="{{ $anketaKey }}">
                                            ...
                                            >
                                                        ...
                                                        @foreach($photos as $phI => $ph)
                                                            ...
                                                            @if($phI == 0)
                                                                <a href="{{ $isUri ? $ph : Storage::url($ph) }}"
                                                                   data-fancybox="gallery_{{ $anketa->id }}"><i
                                                                        class="fa fa-camera"></i> ({{ count($photos) }})</a>
                                                            @else
                                                                <a href="{{ $isUri ? $ph : Storage::url($ph) }}"
                                                                   data-fancybox="gallery_{{ $anketa->id }}"></a>
                                                            @endif
                                                        @endforeach
                                                    @endif
                                                ...
                                                @elseif($field->field === 'videos')
                                                    ...
                                                    @if($anketa[$field->field])
                                                        ...
                                                        @endforeach
                                                    @endif
                                                @elseif($field->field === 'realy' && $type_ankets === 'bdd')
                                                    {{ $anketa['realy'] ?: 'Да' }}
                                                ...
                                                @else
                                                    ...
                                                    @if($type_ankets === 'medic' && $field->field === 'admitted' && $anketa[$field->field] === 'Не допущен')
                                                        @if ($anketa->proba_alko === 'Положительно' or $anketa->test_narko === 'Положительно')
                                                            <a href="{{ route('docs.get', ['type' => 'other', 'anketa_id' => $anketa->id]) }}">Мед.
                                                                Заключение</a>
                                                            <a class="btn btn-danger small"
                                                               href="{{ route('docs.get', ['type' => 'protokol', 'anketa_id' => $anketa->id]) }}">Сформировать
                                                                протокол отстранения</a>
                                        ...
                                        @if($type_ankets === 'pak_queue')
                                            <td class="td-option not-export d-flex">
                                                ...
                                                <a href="{{ route('changePakQueue', ['admitted' => 'Допущен', 'id' => $anketa->id]) }}"
                                                   class="btn btn-sm btn-success"><i class="fa fa-check"></i></a>
                                            </td>

                                            <td class="td-option not-export">
                                                <a href="{{ route('changePakQueue', ['admitted' => 'Не допущен', 'id' => $anketa->id]) }}"
