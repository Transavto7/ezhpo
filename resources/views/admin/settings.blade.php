                ...
                >
                    ...
                    <div class="row px-4">
                        ...
                        <div class="col-lg-9 row">
                            ...
                            <div class="form-group col-lg-6">
                                <label for="time_of_alcohol_ban" class="mb-1">Время запрета на прохождение повторного обследования при положительной пробе на алкоголь</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                            ...
                            <div class="form-group col-lg-6">
                                <label for="time_of_pressure_ban" class="mb-1">Время запрета на прохождение повторного обследования при положительной пробе на алкоголь</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
