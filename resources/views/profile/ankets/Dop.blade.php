...
<div class="form-group row">
    ...
    <article class="col-md-9">
        <input value="{{ $driver_id ?? '' }}" type="number" onch="if(this.value.length >= 6) checkInputProp('hash_id', 'Driver', event.target.value, 'fio', $(event.target).parent())" min="6" name="driver_id" class="MASK_ID_ELEM form-control">
