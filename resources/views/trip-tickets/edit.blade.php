  ...
  <script type="text/javascript">
      ...
      $(document).ready(function () {
        ...
        $('#template_code').change(function () {
          ...
          const transportationTypeSelect = $('#transportation_type')
        ...
        <div class="card-body">
          ...
          <article class="anketa anketa-fields">
            ...
            <form method="POST"
              ...
              <div class="form-group">
                <label class="form-control-label">Внешний номер ПЛ:</label>
                <input type="text" value="{{ $tripTicket->external_number }}"
              ...
              <div class="form-group">
                ...
                <article>
                  <select id="template_code" name="template_code" required class="form-control type-view">
                    @foreach(\App\Enums\TripTicket\TripTicketTemplateEnum::labels() as $key => $label)
                      <option value="{{ $key }}" data-type="pl-{{ $key }}"
