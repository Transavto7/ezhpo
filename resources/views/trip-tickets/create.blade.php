                        ...
                        <form method="POST"
                            ...
                            @if($form === null)
                                ...
                                @if(Auth::user()->access('medic_create'))
                                    <div class="form-group d-flex">
                                        ...
                                        <label class="form-control-label mb-0 ml-2" for="create_is_dop_medic">Создать
                                            неполный МО</label>
                                    </div>
                                @endif
                            @endif
                            ...
                            @if(! $createByForms)
                                <div class="form-group">
                                    ...
                                    <article>
                                        <div class="d-flex">
                                            <input
                                                value="{{ ($form && $form->type_anketa === \App\Enums\FormTypeEnum::TECH) ? $form->details->car_id : ($car_id ?? '') }}"
                                                type="number"
                            ...
                            <div class="clone" id="first-clone">
                                ...
                                <div class="form-group">
                                    ...
                                    <article>
                                        <select name="trip_ticket[0][logistics_method]" required
                                                class="form-control type-view logistics_method">
                                ...
                                <div class="form-group">
                                    ...
                                    <article>
                                        <select name="trip_ticket[0][template_code]" required
                                                class="form-control type-view template_code">
                                            @foreach(\App\Enums\TripTicket\TripTicketTemplateEnum::labels() as $key => $label)
                                                <option data-type="pl-{{ $key }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <article>
                                        <select name="trip_ticket[0][transportation_type]" required
                                                class="form-control type-view transportation_type">
                                            @foreach(\App\Enums\TripTicket\TransportationTypeEnum::labels() as $key => $label)
                                                <option
                                                    ...
                                                    @if(! in_array($key, \App\Enums\TripTicket\TransportationTypeEnum::forTemplate4C())) disabled
                                                    @endif
                                                    value="{{ $key }}">{{ $label }}</option>
                                            @endforeach
                                        </select>
