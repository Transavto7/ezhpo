...
результат иммунохроматографического экспресс теста на наличие наркотического средства/психотропного вещества</textarea>
                ...
                <tr>
                    <td colspan="2">
                        <textarea rows="3" class="doc-input" name="description_1">Выдана справка для обращения к врачу в медицинскую организацию для решения вопроса о наличии у работника признаков временной нетрудоспособности </textarea>
                    </td>
                    <td>
                        <textarea class="doc-input" name="description_2">Составлен протокол контроля трезвости.</textarea>
                    </td>
                    <td>
                        <textarea rows="3" class="doc-input" name="description_3">На основании клинических признаков опьянения направлен на медицинского освидетельствование</textarea>
                    </td>
                </tr>
                <tr>
