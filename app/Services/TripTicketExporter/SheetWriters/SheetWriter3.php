...
final class SheetWriter3 implements SheetWriterInterface
{
    ...
    private function fillTripTicketNumber(): self
    {
        ...
        $this->sheet->setCellValue('BD2', $number);
        $this->sheet->setCellValue('EY2', $number);
    ...
    private function fillPeriod(): self
    {
        ...
        $this->sheet->setCellValue('AL4', $startDate->year);
        $this->sheet->setCellValue('EG4', $startDate->year);
        ...
        $this->sheet->setCellValue('BR4', $endDate->year);
        $this->sheet->setCellValue('FM4', $endDate->year);
